...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PeriodicTask.times_of_excution'
        db.add_column('djcelery_periodictask', 'times_of_excution',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PeriodicTask.times_of_excution'
        db.delete_column('djcelery_periodictask', 'times_of_excution')
    ...
    models = {
        ...
        'djcelery.periodictask': {
            ...
            'times_of_excution': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
