...
* Now depends on Celery 2.3.0 (git master branch)

    To install this dependency execute the following command::

        $ pip install -U http://github.com/ask/celery/tarball/master#egg=celery
